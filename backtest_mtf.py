...
# ==========================================================
# Backtest Position Manager (TradeExecutor için minimal API)
# - TradeExecutor open_position/close_position arıyor.
# - Burada simulated position + realized_pnl üretiyoruz.
# ==========================================================
from dataclasses import dataclass
from datetime import datetime
...
class BacktestPositionManager:
    ...
    TradeExecutor'ın ihtiyaç duyduğu minimum interface:
      - open_position(...) / execute_trade(...)
      - close_position(...)
      - get_open_position(...) / has_open_position(...)
    """

    def __init__(self, risk_manager=None, logger=None):
        self.risk_manager = risk_manager
        self.logger = logger
        self._pos: Optional[BTPosition] = None
...
async def run_backtest() -> None:
    ...
    bt_position_manager = BacktestPositionManager(risk_manager=risk_manager, logger=system_logger)
    ...
    trade_executor = TradeExecutor(
        ...
        position_manager=bt_position_manager,
        logger=system_logger,
        dry_run=True,

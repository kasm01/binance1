...
async def bot_worker():
    ...
    Şimdilik sadece heartbeat + basit Redis yazma denemesi yapıyor.
    """
    ...
    try:
        ...
        system_logger.info("✅ [BOT] Heartbeat key set in Redis.")
    except Exception as e:
        logger.exception(f"[BOT] Redis heartbeat set failed: {e}")
